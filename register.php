...
<div id="container-user-akses">
    <form action="<?php echo BASE_URL."proses_register.php"; ?>" method="POST" enctype="multipart/form-data">
        ...
        <?php
            ...
            $notif = isset($_GET['notif']) ? $_GET['notif'] : false;
            $foto = isset($_GET['foto']) ? $_GET['foto'] : false;

            if ($notif == "require"){
                echo "<div class='notif'>Maaf, semua form harus lengkap dan terisi!</div>";
            }
            else if($notif == "password"){
                echo "<div class='notif'>Maaf, password yang anda masukkan tidak sama</div>";
            }
            else if($notif == "email"){
                echo "<div class='notif'>Maaf, email yang anda masukkan sudah pernah didaftarkan</div>";
            }
        ?>
        ...
        <div class="element-form">
            ...
            <label class="wajib"></label>
            <span>
                <input type="file" name="foto" class="tombol-action"/>
            </span>
        </div>
        <div class="element-form">
