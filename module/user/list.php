<?php
    ...
    else
    {
        ...
        $queryHitungAdmin = mysqli_query($koneksi, "SELECT * FROM user ORDER BY nama ASC");
        pagination($queryHitungAdmin, $data_per_halaman, $pagination, "index.php?page=my_profile&module=user&action=list");
    }
?>