<?php
	...
	$gambar = "<img src='". BASE_URL."images/fotofile/$row[foto]' style='width: 200px;vertical-align: middle;' />";  
	...
	$level = $row["level"];
?>
<form action="<?php echo BASE_URL."module/user/action.php?user_id=$user_id"?>" method="POST" enctype="multipart/form-data">
	...
	<div class="element-form">
		...
		<span><input type="file" name="foto" /><?php echo $gambar; ?></span>
	</div>	  
