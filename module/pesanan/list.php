    ...
    if(mysqli_num_rows($queryPesanan) == 0){
        ...
        echo "<table class='table-list'>
                <tr class='baris-title'>
                    ...
                    <th class='kiri'>Tgl Peminjaman</th>
                    <th class='kiri'>Tgl Pengembalian</th>
        ...
        while($row=mysqli_fetch_assoc($queryPesanan)){
            if($level == "superadmin"){
                $adminButton = "<a class='tombol-actions' href='".BASE_URL."index.php?page=my_profile&module=pesanan&action=status&pesanan_id=$row[pesanan_id]'>Update Status</a>";
            }
            ...
            echo "<tr>
                    ...
                    <td class='kiri'>
                        <a class='tombol-actions' href='".BASE_URL."index.php?page=my_profile&module=pesanan&action=detail&pesanan_id=$row[pesanan_id]'>Detail Pesanan</a>
                        $adminButton
                    </td>
                </tr>";
        }
