<?php
    ...
    $query = mysqli_query($koneksi, "SELECT status,tanggal_pengembalian FROM pesanan WHERE pesanan_id='$pesanan_id'");
    $row=mysqli_fetch_assoc($query);
    $pengembalian = $row['tanggal_pengembalian'];
    $status = $row['status'];
...
<form action="<?php echo BASE_URL."module/pesanan/action.php?pesanan_id=$pesanan_id"; ?>" method="POST">
    ...
    <div class="element-form">
        ...
        <span><input type="date" value="<?php echo $pengembalian; ?>" name="pengembalian" /></span>
    </div>
